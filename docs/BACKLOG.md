...
最終更新: 2026-07-21(ルートスライス03cの完了を反映)
...
- **ステップ3 ルート表示の残り**: 03a〜03cで作図規約・SVG→グラフJSON抽出・Dijkstra・研究棟1F〜3Fの階段接続・研究棟西側出入口〜講堂の屋外経路まで実装済み(ブラウザ確認済み)。講義棟・学生ホール・UBIC・LICTiA等の室内経路と各建物出入口、その他の屋外目的地は未実装。SPEC §3.3、`docs/MAP_AUTHORING.md`参照

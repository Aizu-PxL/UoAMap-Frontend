...
最終更新: 2026-07-20(ルートスライス03a完了を反映)
...
- **ステップ3 ルート表示の残り**: 03aで作図規約・SVG→グラフJSON抽出・Dijkstra・ルート線描画を研究棟1Fの5地点へ実装済み。次は階段による研究棟フロア間接続、その後に建物出入口・屋外経路を追加する。SPEC §3.3、`docs/MAP_AUTHORING.md`参照

...
最終更新: 2026-07-21(ルートスライス03bの完了を反映)
...
- **ステップ3 ルート表示の残り**: 03a・03bで作図規約・SVG→グラフJSON抽出・Dijkstra・研究棟1F〜3Fの階段接続・フロア別描画まで実装済み(ブラウザ確認済み)。次は建物出入口・屋外経路の追加。SPEC §3.3、`docs/MAP_AUTHORING.md`参照

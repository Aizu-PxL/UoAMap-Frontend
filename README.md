...
このコマンドはunit test、TypeScript strict型検査とproduction build、route editor生成物鮮度、125 Place / 89 QR / 61 Event、350 nodes / 448 edgesのRouteグラフ、`git diff --check`を順に検証します。
